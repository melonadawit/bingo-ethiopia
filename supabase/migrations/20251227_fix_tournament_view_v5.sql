-- Finalized public_tournaments_view V5
-- Ensures tournaments disappear EXACTLY and IMMEDIATELY after end_time.
-- Matches 'is_strictly_active' to the actual current time.
-- For visibility, scheduled tournaments that are in their time window are considered strictly active.
...
SELECT 
  ...
  -- is_strictly_active is true if current time is within [start_time, end_time)
